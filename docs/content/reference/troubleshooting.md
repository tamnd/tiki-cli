...
Most of these come down to network reality or how tiki serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

tiki rate-limits like any public site. tiki already paces
...
Where a surface is gated, tiki reads a cookie or token you supply
...
`tiki`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what tiki actually did
