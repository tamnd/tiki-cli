...
// HTTP behaviour is covered in tiki_test.go.
...
func TestDomainInfo(t *testing.T) {
	...
	if info.Identity.Binary != "tiki" {
		t.Errorf("Identity.Binary = %q, want tiki", info.Identity.Binary)
	}
}
...
func TestHostWiring(t *testing.T) {
	...
	if want := "tiki://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("tiki", "about")
	if err != nil || got.String() != "tiki://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want tiki://page/about", got.String(), err)
	}
}
